/**
 * Cancellation Policy Page - Sara Learning Platform
 */
    ...
    <div className="terms-container" style={containerStyle}>
      ...
      <main className="terms-main" style={{ flex: 1, padding: '1rem 0' }}>
        <div className="terms-content" style={{ maxWidth: 800, margin: '0 auto', padding: '1.25rem 2rem 3rem 2rem', background: '#ffffff' }}>
          <h1 style={{ fontSize: '2.5rem', fontWeight: 700, marginBottom: '0.5rem', color: '#10a37f' }}>Cancellation Policy</h1>
          <p className="last-updated">Last updated: February 2026</p>

          <section className="terms-section">
            <h2>1. Overview</h2>
            <p>
              This policy describes how cancellations of access, subscriptions, or services are handled on Sara.
            </p>
          </section>

          <section className="terms-section">
            <h2>2. No Cancellation After Access</h2>
            <p>
              <strong>No cancellation after access.</strong> Once you have paid and received access to the platform or course, cancellation of the purchase is not permitted. Access is non-cancellable and non-refundable as per our Return &amp; Refund Policy.
            </p>
          </section>
